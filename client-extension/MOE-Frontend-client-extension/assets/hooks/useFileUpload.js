...
export const useFileUpload = (t) => {
    ...
    const handleFileUpload = useCallback(async (file, type) => {
        try {
            ...
            formData.append("description", type === "attachment" ? " Attachment" : " Document");
            ...
            if (!uploadResponse.ok) {
                ...
                if (uploadResponse.status === 409 || (errorData.status === "CONFLICT" && errorData.title?.includes("already exists"))) {
                    ...
                    toast.success(t ? t("fileUploadedSuccessfully") : "File uploaded successfully");
                    return {
                        id: retryData.id,
            ...
            toast.error((t ? t("failedToUploadFile") : "Failed to upload file"));
            return null;
        } finally {
